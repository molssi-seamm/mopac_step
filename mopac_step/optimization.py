...
class Optimization(mopac_step.Energy):
    ...
    def get_input(self, references):
        ...
        keywords = []
        for keyword in super().get_input(references):
            if keyword != '1SCF':
        ...
        if method == 'default':
            ...
            references.cite(
                raw=self.bibliography['Baker_1986'],
                alias='Baker_1986',
                module='mopac_step',
                level=1,
            ...
            references.cite(
                raw=self.bibliography['Broyden_1970'],
                alias='Broyden_1970',
                module='mopac_step',
                level=1,
            ...
            references.cite(
                raw=self.bibliography['Fletcher_1970'],
                alias='Fletcher_1970',
                module='mopac_step',
                level=1,
                note='Broyden-Fletcher-Goldfarb-Shanno (BFGS) minimizer.'
            ...
            references.cite(
                raw=self.bibliography['Goldfarb_1970'],
                alias='Goldfarb_1970',
                module='mopac_step',
                level=1,
                note='Broyden-Fletcher-Goldfarb-Shanno (BFGS) minimizer.'
            ...
            references.cite(
                raw=self.bibliography['Shanno_1970'],
                alias='Shanno_1970',
                module='mopac_step',
                level=1,
                note='Broyden-Fletcher-Goldfarb-Shanno (BFGS) minimizer.'
            ...
            references.cite(
                raw=self.bibliography['Thiel_1988'],
                alias='Thiel_1988',
                module='mopac_step',
                level=1,
                note='Broyden-Fletcher-Goldfarb-Shanno (BFGS) minimizer.'
            ...
            references.cite(
                raw=self.bibliography['Nocedal_1980'],
                alias='Nocedal_1980',
                module='mopac_step',
                level=1,
            ...
            references.cite(
                raw=self.bibliography['McIver_1971'],
                alias='McIver_1971',
                module='mopac_step',
                level=1,
            ...
            references.cite(
                raw=self.bibliography['McIver_1972'],
                alias='McIver_1972',
                module='mopac_step',
                level=1,
                note='Gradient-norm minimizer for transition states.'
            ...
            references.cite(
                raw=self.bibliography['Bartels_1972'],
                alias='Bartels_1972',
                module='mopac_step',
                level=1,
