...
Installation
============
The MOPAC step is probably already installed in your SEAMM environment, but
...
check for `mopac-step`. If it is not installed, or can be updated, check the box
...
The non-graphical installer is also straightforward::
  ...
  seamm-installer install --update mopac-step
